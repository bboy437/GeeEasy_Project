...
@Component({
  selector: "project-file-upload-note",
  templateUrl: "./file-upload-note.component.html",
  styleUrls: ["./file-upload-note.component.scss"]
})
export class FileUploadNoteComponent implements OnInit {
  @Input() theme = "white";
