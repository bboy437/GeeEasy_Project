...
@Component({
  selector: 'project-comp-category-own',
  templateUrl: './comp-category-own.component.html',
  styleUrls: ['./comp-category-own.component.scss']
})
export class CompCategoryOwnComponent implements OnInit {
  ...
  get_category_start(callback) {
    ...
    if (this.status === 'Distributor') {
      const valueCategory = 'cur_page=' + 1 + '&per_page=' + 100 + "&main=" + 1;
