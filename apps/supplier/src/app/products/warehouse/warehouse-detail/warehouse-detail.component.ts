...
export class WarehouseDetailComponent implements OnInit {
  ...
  Builder() {
    this.Form = this.fb.group({
      ...
      warehouse_addr_address_full: [
        { value: "", disabled: true },
        Validators.required
      ],
      warehouse_addr_number: [
        { value: "", disabled: true },
        Validators.required
      ],
      warehouse_addr_tambon: [
        { value: "", disabled: true },
        Validators.required
      ],
      warehouse_addr_amphoe: [
        { value: "", disabled: true },
        Validators.required
      ],
      warehouse_addr_province: [
        { value: "", disabled: true },
        Validators.required
      ],
  ...
  DetailForm() {
    this.Form.patchValue({
      ...
      warehouse_lat_log:
        this.arrobjRow.warehouse_lat + "," + this.arrobjRow.warehouse_lng
    });
    this.loading = false;
  }
  ...
  btnSaveClick() {
    this.router.navigate([
      this.UrlRouter_warehouseEdit,
      this.arrobjRow.warehouse_id
    ]);
  }
}
