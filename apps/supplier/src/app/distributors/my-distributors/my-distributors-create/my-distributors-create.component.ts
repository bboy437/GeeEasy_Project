...
@Component({
    selector: "project-my-distributors-create",
    templateUrl: "./my-distributors-create.component.html",
    styleUrls: ["./my-distributors-create.component.scss"]
})
export class MyDistributorsCreateComponent implements OnInit {
    ...
    changeTambon(location_name) {
        if (this.arrTambon.length > 0) {
            ...
            this.DistributorForm.get('distributor_addr_lng').patchValue(0);
            this.DistributorForm.get('latitudeAndLongitude').patchValue(0 + ',' + 0);
            console.log("DistributorForm", this.DistributorForm.value);
        }
    }
    ...
    save() {
        if (this.RowID === "new") {
            ...
            console.log("save : dataJson : ", dataNew);
