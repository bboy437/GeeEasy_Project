...
function matches(country: IwishlistDetail, term: string, pipe: PipeTransform) {
  return country.create_time.toString().toLowerCase().includes(term.toString().toLowerCase())
    ...
    || country.distributor_addr_amphoe.toString().toLowerCase().includes(term.toString().toLowerCase())
    || country.distributor_addr_province.toString().toLowerCase().includes(term.toString().toLowerCase())
}
