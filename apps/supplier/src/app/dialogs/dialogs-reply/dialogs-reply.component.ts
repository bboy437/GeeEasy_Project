...
@Component({
  ...
  templateUrl: './dialogs-reply.component.html',
  styleUrls: ['./dialogs-reply.component.scss']
})
export class DialogsReplyComponent implements OnInit {
  @Input() data: any;
  arrobjRow: any = {};
  ReplyForm: FormGroup;
  submitted = false;
  ...
  constructor(
    ...
    protected ref: NbDialogRef<DialogsReplyComponent>,
  ) { }
