...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: "purchase-order/:id/:typeid/:status",
        component: DocPurchaseOrderComponent
      },
      {
        path: "proforma-invoice/:id/:typeid/:status",
        component: DocProformaInvoiceComponent
      },
      {
        path: "commercial-invoice/:id/:typeid/:status",
        component: DocCommercialInvoiceComponent
      },
      {
        path: "order-confirmation/:id/:typeid/:status",
        component: DocOrderConfirmationComponent
      }
    ]
  }
];
