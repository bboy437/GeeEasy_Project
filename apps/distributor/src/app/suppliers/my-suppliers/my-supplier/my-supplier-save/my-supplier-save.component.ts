...
@Component({
    selector: 'project-my-supplier-save',
    templateUrl: './my-supplier-save.component.html',
    styleUrls: ['./my-supplier-save.component.scss'],
...
export class MysupplierSaveComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.RowID === "new") {
            ...
            this.supplierAPIService.dataSupplier$.subscribe(res => {
                res ? this.getData(res) : this.router.navigate([this.UrlRouter_Supplier]);
