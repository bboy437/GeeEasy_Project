...
@Component({
  selector: "project-doc-proforma-invoice",
  templateUrl: "./doc-proforma-invoice.component.html",
  styleUrls: ["./doc-proforma-invoice.component.scss"]
})
export class DocProformaInvoiceComponent implements OnInit {
  arrDoc: any = [];
  arrDocFrom: any = {};
  arrDocTo: any = {};
  rowID: string;
