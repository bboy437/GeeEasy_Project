...
import { FarvoriteTableService } from './product-farvorite-table.service';

@Component({
  selector: 'project-farvorite',
  templateUrl: './product-farvorite.component.html',
  styleUrls: ['./product-farvorite.component.scss'],
