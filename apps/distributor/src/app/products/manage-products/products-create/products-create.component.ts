  ...
  getCategory() {
    ...
    this.browseSupplierAPIService.getCategory(value).subscribe(data => {
      ...
      if (this.RowID !== "new") {
        ...
        setTimeout(() => {
          this.Form.get("productCategory").patchValue(this.arrobjRow.product_category_array.length === 0 ? "" : +this.arrobjRow.product_category_array[0].product_category_id);
    ...
    this.warehouseAPIService.getWarehouseList(value).subscribe(data => {
      ...
      if (this.RowID !== "new") {
        setTimeout(() => {
          ...
          this.Form.get("warehouse_name").disable();
        }, 0);
      }
    ...
    this.uploadAPIService
      ...
      .getImageArrayState(this.product.product_image_array.get, state => {
        ...
        if (this.RowID === "new") {
          ...
          console.log("Form", this.Form.value.sku);
          console.log("Form", this.Form.value.productSKU);
          if (
