...
import { ProductCreateGuard } from './manage-products/products-create/products-create-guard';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: "manage/create/:id", canDeactivate: [ProductCreateGuard], component: ProductsCreateComponent },
